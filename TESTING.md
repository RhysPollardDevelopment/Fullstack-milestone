...
## Functionality    
The table below details the current functionality of the entire Freebees site, following any corrections and updates which can be in the [bug](#bugs) section.  
