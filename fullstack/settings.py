...
# Use of dotenv to access security key in environment.
...
# Link and parsing of heroku postgres database
# Will use sqlite3 is DATABASE_URL is not in environment settings
...
# Media files directories added for local/development environment.
MEDIA_URL = "/media/"
MEDIA_ROOT = os.path.join(BASE_DIR, "media")

if "USE_AWS" in os.environ:
    # cache control to increase loading times
    AWS_S3_OBJECT_PARAMETERS = {
        "Expires": "Thu, 31 Dec 2099 20:00:00 GMT",
        "CacheControl": "max-age=94608000",
    }

    AWS_STORAGE_BUCKET_NAME = "freebees-fullstack-milestone"
...
if "DEVELOPMENT" in os.environ:
    ...
    DEFAULT_FROM_EMAIL = "freebees@example.com"
else:
